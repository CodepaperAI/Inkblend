...
export function CtaBand() {
  return (
    <section className="px-4 py-20 sm:px-6 lg:px-8">
      <Reveal className="mx-auto max-w-7xl overflow-hidden rounded-[2rem] border border-white/10 bg-[linear-gradient(135deg,rgba(247,39,39,0.26),rgba(249,167,43,0.1),rgba(44,56,146,0.22))] p-1">
        <div className="relative overflow-hidden rounded-[1.8rem] bg-black/76 px-6 py-14 backdrop-blur-xl sm:px-10 lg:px-14">
          ...
          <div className="relative grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
            <div>
              ...
              <h2 className="mt-4 max-w-3xl font-display text-5xl leading-[0.92] text-white sm:text-6xl">
